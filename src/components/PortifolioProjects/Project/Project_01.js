        ...
        <div className="row">
            <div className="col-lg-8 col-lg-offset-2" id="portfolioModal3">
                <div className="modal-body">
                    <h2 className=" text-center">Eventex - O maior encontro haker do mundo!</h2>
                    ...
                    <h6>Python/Django</h6>
                    <p>O Sistema de gestão de eventos
                        <a href="https://eventex-adrianoregis.herokuapp.com/">Eventex</a>,
